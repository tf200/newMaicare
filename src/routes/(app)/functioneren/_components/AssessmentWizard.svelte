			...
			questions: [
				{
					id: 'vsl-1',
					question:
						'Voorspelbaarheid als fundament: Consistent dagritme hanteren met vaste tijdstippen voor maaltijden, school, huiswerk, vrije tijd en bedtijd.'
				},
				{
					id: 'vsl-2',
					question:
						'Fysieke en emotionele veiligheid: Zorgen voor een schone, ordelijke en huiselijke leefomgeving. Een sfeer creëren waarin jeugdigen zich gehoord voelen.'
				},
				{
					id: 'vsl-3',
					question:
						'Structuur door heldere kaders: Duidelijke, haalbare en consistente groepsregels hanteren. De waarom achter regels uitleggen.'
				},
				{
					id: 'vsl-4',
					question:
						'Rust en ruimte voor herstel: Prikkelniveaus bewaken, conflicten de-escaleren en ontspanning faciliteren.'
				},
				{
					id: 'vsl-5',
					question:
						'Rituelen en groepsgevoel: Vaste gewoontes gebruiken die geborgenheid en groepsgevoel versterken.'
				}
			]
		},
		{
			...
			questions: [
				{
					id: 'adl-1',
					question:
						'Praktische levensvaardigheden: Koken, boodschappen doen, budgetbeheer, huishouden en administratie.'
				},
				{
					id: 'adl-2',
					question:
						'Zelfzorg en hygiëne: Sensitief begeleiden bij persoonlijke verzorging met respect voor privacy en autonomie.'
				},
				{
					id: 'adl-3',
					question:
						'Gezondheid en welzijn: Gezond eten, beweging en slaapritme stimuleren. Medicatiebegeleiding volgens protocol.'
				},
				{
					id: 'adl-4',
					question:
						'Dagindeling en tijdmanagement: Plannen van schooltaken, afspraken en vrijetijdsbesteding.'
				},
				{
					id: 'adl-5',
					question:
						"Vrijetijdsbesteding: Zinvolle hobby's, sport en sociale contacten buiten de groep faciliteren."
				}
			]
		},
		{
			...
			questions: [
				{
					id: 'so-1',
					question:
						'Sociale vaardigheden trainen: Oefenen met contact maken, conflicten oplossen en samenwerken via groepsactiviteiten.'
				},
				{
					id: 'so-2',
					question:
						'Emotieregulatie versterken: Herkennen, benoemen en constructief uiten van emoties.'
				},
				{
					id: 'so-3',
					question:
						'Zelfredzaamheid vergroten: Stapsgewijs verantwoordelijkheid geven passend bij ontwikkelingsniveau.'
				},
				{
					id: 'so-4',
					question:
						'Zelfvertrouwen opbouwen: Successen benadrukken, positieve bekrachtiging geven, talenten ontdekken.'
				},
				{
					id: 'so-5',
					question:
						'Cognitieve ontwikkeling ondersteunen: Hulp bij huiswerk, contact met school, leeromgeving bieden.'
				}
			]
		},
		{
			...
			questions: [
				{
					id: 'ob-1',
					question:
						'Positief en constructief corrigeren: Focus op gewenst gedrag, uitleg geven over gevolgen.'
				},
				{
					id: 'ob-2',
					question:
						'Relationeel begrenzen: Grenzen stellen vanuit verbinding. Relatie herstellen na correctie.'
				},
				{
					id: 'ob-3',
					question:
						'Afstemmen op onderliggende behoeftes: Kijken voorbij het gedrag naar angst, onmacht of aandacht.'
				},
				{
					id: 'ob-4',
					question: 'Variëren in opvoedstijlen: Schakelen tussen autoritatieve en coachende stijl.'
				},
				{
					id: 'ob-5',
					question:
						'Methodische interventies: Technieken toepassen zoals Geef me de 5 of Nieuwe Autoriteit.'
				}
			]
		},
		{
			...
			questions: [
				{
					id: 'ib-1',
					question: 'Behandelplannen vertalen: Dagelijkse doelen koppelen aan behandeldoelen.'
				},
				{
					id: 'ib-2',
					question: 'Persoonlijk ontwikkelingsplan: Samen haalbare doelen opstellen en evalueren.'
				},
				{
					id: 'ib-3',
					question:
						'1-op-1 gesprekken: Individuele tijd inplannen voor voortgang, zorgen en wensen.'
				},
				{
					id: 'ib-4',
					question:
						'Multidisciplinaire samenwerking: Bevindingen delen met pedagogen, psychologen en artsen.'
				},
				{
					id: 'ib-5',
					question: 'Systemisch werken: Begeleiding afstemmen op groep, familie en school.'
				}
			]
		}
	];
...
<div class="space-y-6">
			...
			{#each ['Start', ...domains.map((d) => d.short), 'Afronden'] as step, i}
				<div class="flex items-center">
					<div class="flex flex-col items-center gap-1">
						...
						<span
							class="text-[10px] font-bold {i === currentStep ? 'text-text' : 'text-text-subtle'}"
							>{step}</span
						>
					</div>
					{#if i < totalSteps - 1}
	...
	{#if submitted}
		<!-- Success state -->
		<div
			class="rounded-2xl border border-emerald-200/60 bg-emerald-50/40 p-8 text-center dark:border-emerald-800/30 dark:bg-emerald-950/20"
		>
			...
			<p class="mt-1 text-sm text-text-muted">
				...
				{#if allLowScores().length > 0}
					· <span class="font-semibold text-amber-600 dark:text-amber-400"
						>{allLowScores().length} werkadvies(sen) aangemaakt</span
					>
				{/if}
			</p>
		...
		<div class="rounded-2xl border border-border bg-surface">
			...
			<div class="border-b border-border px-6 py-4">
				<div class="flex items-center gap-3">
					{#if currentStep === 0}
						<div
							class="flex h-8 w-8 items-center justify-center rounded-lg bg-rose-500/10 text-rose-600 dark:text-rose-400"
						>
							<span class="text-xs font-bold">1</span>
						</div>
					{:else if currentDomain()}
						<div
							class="flex h-8 w-8 items-center justify-center rounded-lg bg-rose-500/10 text-xs font-bold text-rose-600 dark:text-rose-400"
						>
							{currentDomain()?.short}
						</div>
					{:else}
			...
			<div class="p-6">
				{#if currentStep === 0}
					...
					<div class="max-w-md space-y-5">
						<div>
							<label class="mb-1.5 block text-xs font-bold tracking-wide text-text-subtle uppercase"
								>Functie</label
							>
							<Select
								value="jeugdwerker-d"
				...
				{:else if currentStep > 0 && currentStep <= domains.length}
					...
					<div class="space-y-6">
						{#each currentDomain()?.questions ?? [] as question, qIdx}
							<div class="space-y-3">
								<p class="text-[13px] leading-relaxed font-semibold text-text">
								...
								{#if answers[question.id] !== undefined && answers[question.id] <= 5}
									<div
										class="rounded-xl border border-amber-200/60 bg-amber-50/50 p-3 dark:border-amber-800/30 dark:bg-amber-950/20"
									>
										<label
											class="mb-1.5 block text-[11px] font-bold text-amber-700 dark:text-amber-400"
										>
											Toelichting vereist bij score ≤ 5
										</label>
										<textarea
											class="w-full rounded-lg border border-amber-200/50 bg-surface px-3 py-2 text-[13px] text-text placeholder:text-text-subtle focus:border-amber-400 focus:ring-1 focus:ring-amber-400/30 focus:outline-none dark:border-amber-800/50"
											rows="2"
											placeholder="Geef een toelichting waarom deze score is gegeven..."
											value={remarks[question.id] ?? ''}
											oninput={(e) => {
												remarks[question.id] = (e.target as HTMLTextAreaElement).value;
											}}
										></textarea>
									</div>
								{/if}
				...
				{:else}
					...
					<div class="space-y-6 text-center">
						<div
							class="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-rose-500/10"
						>
						...
						{#if allLowScores().length > 0}
							<div
								class="mx-auto max-w-lg rounded-xl border border-amber-200/60 bg-amber-50/50 p-4 text-left dark:border-amber-800/30 dark:bg-amber-950/20"
							>
								<div class="flex items-center gap-2 text-amber-700 dark:text-amber-400">
									<AlertTriangle class="h-4 w-4" />
									<span class="text-[11px] font-bold tracking-wider uppercase"
										>Werkadvies wordt aangemaakt</span
									>
								</div>
								<div class="mt-2 space-y-1.5">
									{#each allLowScores() as item}
										<div class="flex items-center gap-2 text-[12px]">
											<span
												class="inline-flex h-5 w-5 items-center justify-center rounded-full {item.score <=
												4
													? 'bg-error/10 text-error'
													: 'bg-amber-500/10 text-amber-600 dark:text-amber-400'} text-[10px] font-bold"
												>{item.score}</span
											>
			...
			<div class="flex items-center justify-between border-t border-border px-6 py-4">
				...
				{#if currentStep < totalSteps - 1}
					<button
						class="flex h-9 items-center gap-1.5 rounded-lg bg-rose-500 px-4 text-[12px] font-bold text-white shadow-sm transition-all hover:bg-rose-600 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40"
						onclick={() => currentStep++}
						disabled={!canProceed()}
					>
