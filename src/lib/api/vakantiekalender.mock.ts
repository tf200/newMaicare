...
const mockLeaveRequests: LeaveRequest[] = [
	// March 2026
	makeLeave('lr-001', 'emp-001', 'vakantie', '2026-03-02', '2026-03-06', 5, 37.5, 'approved', 'Voorjaarsvakantie'),
	makeLeave('lr-002', 'emp-003', 'vakantie', '2026-03-09', '2026-03-13', 5, 37.5, 'approved'),
	makeLeave('lr-003', 'emp-007', 'verlofbudget', '2026-03-16', '2026-03-18', 3, 22.5, 'approved', 'Privé afspraak'),
	...
	makeLeave('lr-006', 'emp-002', 'bijzonder', '2026-03-05', '2026-03-05', 1, 7.5, 'approved', 'Verhuizing'),
	...
	// April 2026
	makeLeave('lr-012', 'emp-001', 'vakantie', '2026-04-06', '2026-04-10', 5, 37.5, 'approved', 'Meivakantie'),
	makeLeave('lr-013', 'emp-003', 'verlofbudget', '2026-04-20', '2026-04-22', 3, 22.5, 'approved'),
	makeLeave('lr-014', 'emp-004', 'vakantie', '2026-04-27', '2026-04-27', 1, 6, 'approved', 'Koningsdag'),
	// January 2026
	makeLeave('lr-015', 'emp-010', 'vakantie', '2026-01-05', '2026-01-09', 5, 37.5, 'approved'),
	makeLeave('lr-016', 'emp-005', 'bijzonder', '2026-01-15', '2026-01-15', 1, 7.5, 'approved', 'Trouwerij')
];
