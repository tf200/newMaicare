...
const mockEntries: TimeEntry[] = [
	...
	make(
		...
		'regular',
		'zorg',
		'Begeleiding dagbesteding groep A',
		'Woonlocatie De Es',
		'approved'
	),
	make(
	...
	make(
		...
		'regular',
		'zorg',
		'Begeleiding middagactiviteiten',
		'Woonlocatie De Es',
		'submitted'
	),
	make(
...
export function listMockTimeEntries() {
	return delay(350).then(() => ({ data: mockEntries, success: true }) as ApiEnvelope<TimeEntry[]>);
}
